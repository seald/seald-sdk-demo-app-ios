...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    NSAssert(retrieveNoAccount != nil, @"assertion fail");
    ...
    NSAssert(error == nil, @"assertion fail");
    ...
    NSAssert([retrieveAccountInfo.userId isEqualToString:user1AccountInfo.userId], @"assertion fail");
    NSAssert([retrieveAccountInfo.deviceId isEqualToString:user1AccountInfo.deviceId], @"assertion fail");
    ...
    NSAssert(error == nil, @"assertion fail");
    NSAssert([decryptedMessage isEqualToString:initialString], @"assertion fail");
    ...
    NSAssert(error == nil, @"assertion fail");
    NSAssert([decryptedMessageFromMess isEqualToString:initialString], @"assertion fail");
    ...
    NSAssert(error == nil, @"assertion fail");
    NSAssert([decryptedMessageSDK2 isEqualToString:initialString], @"assertion fail");
    ...
    NSAssert(error == nil, @"assertion fail");
    NSAssert([decryptedMessageSDK3 isEqualToString:initialString], @"assertion fail");
    ...
    NSAssert(range.location != NSNotFound, @"assertion fail");
    error = nil;
    ...
    NSAssert(error == nil, @"assertion fail");
    NSAssert([initialString isEqualToString:decryptedMessageAfterAdd], @"assertion fail");
    ...
    NSAssert(error == nil, @"assertion fail");
    NSAssert([anotherMessage isEqualToString:decryptedMessageAfterRenew], @"assertion fail");
    ...
    NSAssert([connectors count] == 1, @"assertion fail");
    NSAssert([@"AP" isEqualToString:connectors[0].type], @"assertion fail");
    NSAssert([@"VO" isEqualToString:connectors[0].state], @"assertion fail");
    NSAssert([user1AccountInfo.userId isEqualToString:connectors[0].sealdId], @"assertion fail");
    NSAssert([expectedConnectorValue isEqualToString:connectors[0].value], @"assertion fail");
    
    // Retrieve connector by its id
    SealdConnector *retrieveConnector = [sdk1 retrieveConnector:connectors[0].connectorId error:&error];
    NSAssert(error == nil, @"assertion fail");
    NSAssert([@"AP" isEqualToString:retrieveConnector.type], @"assertion fail");
    NSAssert([@"VO" isEqualToString:retrieveConnector.state], @"assertion fail");
    NSAssert([user1AccountInfo.userId isEqualToString:retrieveConnector.sealdId], @"assertion fail");
    NSAssert([expectedConnectorValue isEqualToString:retrieveConnector.value], @"assertion fail");
    ...
    NSAssert(error == nil, @"assertion fail");
    NSAssert([connectorsFromSealdId count] == 1, @"assertion fail");
    NSAssert([@"AP" isEqualToString:connectorsFromSealdId[0].type], @"assertion fail");
    NSAssert([@"VO" isEqualToString:connectorsFromSealdId[0].state], @"assertion fail");
    NSAssert([user1AccountInfo.userId isEqualToString:connectorsFromSealdId[0].sealdId], @"assertion fail");
    NSAssert([expectedConnectorValue isEqualToString:connectorsFromSealdId[0].value], @"assertion fail");
    ...
    NSAssert(error == nil, @"assertion fail");
    NSAssert([sealdIds count] == 1, @"assertion fail");
    NSAssert([user1AccountInfo.userId isEqualToString:sealdIds[0]], @"assertion fail");
    ...
    NSAssert(error == nil, @"assertion fail");
    NSAssert([connectorListAfterRevoke count] == 0, @"assertion fail");
    ...
    NSAssert(error == nil, @"assertion fail");
    NSAssert([anotherMessage isEqualToString:clearMessageExportedIdentity], @"assertion fail");
    ...
    NSAssert(error == nil, @"assertion fail");
    NSAssert(subIdentity.deviceId != nil, @"assertion fail");
    ...
    NSAssert(error == nil, @"assertion fail");
    NSAssert([anotherMessage isEqualToString:clearMessageSubdIdentity], @"assertion fail");
