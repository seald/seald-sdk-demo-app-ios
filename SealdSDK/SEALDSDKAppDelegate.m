...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    NSAssert(error == nil, @"fail to instantiate Seald SDK");
    ...
    NSAssert(retrieveNoAccount == nil, [error localizedDescription]);
    ...
    NSAssert([retrieveAccountInfo.userId isEqualToString:user1AccountInfo.userId], [error localizedDescription]);
    NSAssert([retrieveAccountInfo.deviceId isEqualToString:user1AccountInfo.deviceId], [error localizedDescription]);
    ...
    NSAssert(error == nil, [error localizedDescription]);
    NSAssert([decryptedMessage isEqualToString:initialString], [error localizedDescription]);
    ...
    NSAssert(error == nil, [error localizedDescription]);
    NSAssert([decryptedMessageFromMess isEqualToString:initialString], [error localizedDescription]);
    ...
    NSAssert(error == nil, [error localizedDescription]);
    NSAssert([decryptedMessageSDK2 isEqualToString:initialString], [error localizedDescription]);
    ...
    NSAssert(error == nil, [error localizedDescription]);
    NSAssert([decryptedMessageSDK3 isEqualToString:initialString], [error localizedDescription]);
    ...
    NSAssert(range.location != NSNotFound, [error localizedDescription]);
    error = nil;
    ...
    NSAssert(error == nil, [error localizedDescription]);
    NSAssert([initialString isEqualToString:decryptedMessageAfterAdd], [error localizedDescription]);
    ...
    NSAssert(error == nil, [error localizedDescription]);
    NSAssert([anotherMessage isEqualToString:decryptedMessageAfterRenew], [error localizedDescription]);
    ...
    NSAssert([connectors count] == 1, [error localizedDescription]);
    NSAssert([@"AP" isEqualToString:connectors[0].type], [error localizedDescription]);
    NSAssert([@"VO" isEqualToString:connectors[0].state], [error localizedDescription]);
    NSAssert([user1AccountInfo.userId isEqualToString:connectors[0].sealdId], [error localizedDescription]);
    NSAssert([expectedConnectorValue isEqualToString:connectors[0].value], [error localizedDescription]);
    
    // Retrieve connector by its id
    SealdConnector *retrieveConnector = [sdk1 retrieveConnector:connectors[0].connectorId error:&error];
    NSAssert(error == nil, [error localizedDescription]);
    NSAssert([@"AP" isEqualToString:retrieveConnector.type], [error localizedDescription]);
    NSAssert([@"VO" isEqualToString:retrieveConnector.state], [error localizedDescription]);
    NSAssert([user1AccountInfo.userId isEqualToString:retrieveConnector.sealdId], [error localizedDescription]);
    NSAssert([expectedConnectorValue isEqualToString:retrieveConnector.value], [error localizedDescription]);
    ...
    NSAssert(error == nil, [error localizedDescription]);
    NSAssert([connectorsFromSealdId count] == 1, [error localizedDescription]);
    NSAssert([@"AP" isEqualToString:connectorsFromSealdId[0].type], [error localizedDescription]);
    NSAssert([@"VO" isEqualToString:connectorsFromSealdId[0].state], [error localizedDescription]);
    NSAssert([user1AccountInfo.userId isEqualToString:connectorsFromSealdId[0].sealdId], [error localizedDescription]);
    NSAssert([expectedConnectorValue isEqualToString:connectorsFromSealdId[0].value], [error localizedDescription]);
    ...
    NSAssert(error == nil, [error localizedDescription]);
    NSAssert([sealdIds count] == 1, [error localizedDescription]);
    NSAssert([user1AccountInfo.userId isEqualToString:sealdIds[0]], [error localizedDescription]);
    ...
    NSAssert(error == nil, [error localizedDescription]);
    NSAssert([connectorListAfterRevoke count] == 0, [error localizedDescription]);
    ...
    NSAssert(error == nil, [error localizedDescription]);
    NSAssert([anotherMessage isEqualToString:clearMessageExportedIdentity], [error localizedDescription]);
    ...
    NSAssert(error == nil, [error localizedDescription]);
    NSAssert(subIdentity.deviceId != nil, [error localizedDescription]);
    ...
    NSAssert(error == nil, [error localizedDescription]);
    NSAssert([anotherMessage isEqualToString:clearMessageSubdIdentity], [error localizedDescription]);
